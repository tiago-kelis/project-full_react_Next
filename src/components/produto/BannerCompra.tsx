...
export default function BannerCompra(props: BannerCompraProps) {
    ...
    const parcelamento = UseParcelamento(produto.precoPromocional, QTDE_MAX_PARCELAS)
    ...
    return (
        <div className="flex">
            ...
            <div className="flex-1 flex flex-col text-2xl font-semibold text-zinc-400 pl-5">
                <span className="text-base text-zinc-300">{parcelamento.qtdeParcela}x de</span>
